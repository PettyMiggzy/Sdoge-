 ...
 * can't yet trade through Arc's Uniswap v4 hook pools, so it marks every
        ...
        <>
          ...
          {s.honeypotFlag && (
            <p className="mt-3 rounded-lg border border-line bg-panel2/60 p-3 text-xs text-muted">
              About the honeypot flag: GoPlus&apos;s test trade can&apos;t go through Arc&apos;s Uniswap v4 hook pools yet, so it
              flags every token on one, $SDOGE included. Every {CONFIG.brand} token is a plain ERC-20 with no owner,
