...
export async function GET() {
  ...
  return apiJson({
    ...
    contracts: {
      ...
      universalRouter: CONFIG.router, permit2: CONFIG.permit2, usdc: CONFIG.usdc,
    },
    ...
    sdk: 'https://github.com/PettyMiggzy/Sdoge-/tree/claude/stable-doge-arc-launch-zlx78f/pad-sdk',
  }, { maxAge: 30 });
}
