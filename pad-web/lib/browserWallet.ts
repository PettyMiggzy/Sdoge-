...
/** Switches the wallet to Arc, adding the network first if the wallet doesn't know it. */
export async function switchWalletToArc(p: Eip1193Provider): Promise<void> {
  const want = numberToHex(arc.id);
